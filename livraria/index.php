...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3" style="margin-top: 45px;margin-right: 0px;padding-top: 0px;">
                <figure class="figure"><img class="img-fluid figure-img">
                    <figcaption class="figure-caption">Caption</figcaption>
                </figure>
            </div>
    ...
    <footer class="text-center bg-dark">
        <div class="container text-white py-4 py-lg-5" style="margin-top: 171px;"><a href="/index.html" style="border-style: none;">Livraria Camões</a>
