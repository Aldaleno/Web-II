                    ...
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form class="text-center" method="post">
                                ...
                                <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit">Login</button><button class="btn btn-primary d-block w-100" type="submit" style="margin-top: 26px;padding-top: 7px;padding-bottom: 6px;"><a href="signup.php" class="btn btn-primary d-block w-100">SignUp</a></button></div>
                            </form>
                        </div>
                    </div>
                </div>
